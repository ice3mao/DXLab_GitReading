...
func main() {
	...
	Info("git clone %s %s", "https://github.com/ice3mao/DXLab_GitReading.git", "/git")

	r, err := git.PlainClone("/git", false, &git.CloneOptions{URL: "https://github.com/ice3mao/DXLab_GitReading.git"})
	CheckIfError(err)
